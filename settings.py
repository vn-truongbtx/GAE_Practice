...
SECRET_KEY = 's!)p!b#fxuo33r1=%nudamxe#(o%(w48@b4x1te%^a$_f#6^!+'
...
# WSGI_APPLICATION = 'django_appengine.wsgi.application'
...
TEMPLATE_DIRS = (
    TEMPLATE_ROOT,
    # os.path.join(BASE_DIR, 'django_appengine/templates'),
)
